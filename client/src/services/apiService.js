...
class ApiService {
  ...
  // NEW: Dummy Payment Processing
  static async processDummyPayment(data) {
    return axios.post("/api/v1/payments/dummy-payment", data);
  }

  // Updated for existing schema - Get Dashboard Data
